...
test('add friend screen is a minimal circle-id search flow', () => {
  ...
  assert.match(source, /输入对方圈号/);
  assert.match(source, /圈号：\{result\.accountId\}/);
  ...
  assert.doesNotMatch(source, /账号：\{result\.accountId\}/);
